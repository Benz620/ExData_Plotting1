...
plot(data2$datetime, data2$Voltage, type="l",xlab="datetime",ylab="Voltage", xaxt="n")
axis(side=1,seq(min(data2$datetime),max(data2$datetime),length=3),labels = c("Thu","Fri","Sat"))
...
plot(data2$datetime, data2$Global_reactive_power, type="l",xlab="",ylab="Global_reactive_power", xaxt="n")
axis(side=1,seq(min(data2$datetime),max(data2$datetime),length=3),labels = c("Thu","Fri","Sat"))
